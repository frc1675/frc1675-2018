...
public class OI {
    ...
    JoystickButton driverLeftJoystickButton = new JoystickButton(driverController,
            XBoxControllerMap.LEFT_JOYSTICK_BUTTON);
    JoystickButton driverRightJoystickButton = new JoystickButton(driverController,
